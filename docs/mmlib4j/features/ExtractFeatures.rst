...
.. java:method:: public Matrix X()
   :outertype: ExtractFeatures

Y
^

.. java:method:: public Matrix Y()
   :outertype: ExtractFeatures

featureExtractionOfAscendant
^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. java:method:: public void featureExtractionOfAscendant(NodeLevelSets node, Matrix matrix, int row)
   :outertype: ExtractFeatures

featureExtractionOfDescendant
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. java:method:: public void featureExtractionOfDescendant(NodeLevelSets node, Matrix matrix, int row)
   :outertype: ExtractFeatures

find
^^^^

.. java:method:: public ExtractFeatures find(int delta)
   :outertype: ExtractFeatures
...
.. java:method:: public Matrix sample(NodeLevelSets node)
   :outertype: ExtractFeatures

samples
^^^^^^^

.. java:method:: public Matrix samples()
   :outertype: ExtractFeatures
...
.. java:method:: public double stableAttribute(NodeLevelSets node, int att)
   :outertype: ExtractFeatures
...
.. java:method:: public Matrix y(NodeLevelSets node)
   :outertype: ExtractFeatures
